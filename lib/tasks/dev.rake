namespace :dev do
  ...
  task setup: :environment do
    if Rails.env.development?
      ...
      show_spinner("Cadastrando administradores extras...") { %x(rails dev:add_admins_extra) }
  ...
  task add_admins_extra: :environment do
    10.times do |i|
      Admin.create!(
  ...
  task add_answers_and_questions: :environment do
    Subject.all.each do |subject|
      rand(5..10).times do |i|
        ...
        create_answer_params(answers_array)
  ...
  # Rodar o comando: rails dev:reset_subjects_counters
